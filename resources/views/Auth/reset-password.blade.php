...
@section('title', 'Reset Password - ParkFlow')
...
<div class="lp-page">
  ...
  <div class="lp-card">
    <div class="lp-eyebrow">Password Reset</div>
    <div class="lp-title">Reset Password</div>
    <div class="lp-sub">Enter your new password below to regain access.</div>
    ...
    <form method="POST" action="{{ route('password.store') }}" autocomplete="off">
      ...
      <div class="lp-field">
        ...
        @error('password_confirmation') <div class="lp-ferr">{{ $message }}</div> @enderror
      </div>
