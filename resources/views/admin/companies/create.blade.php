...
@section('content')
  ...
  <div class="pf-form-panel">
    <div class="pf-form-head">
      <div class="pf-form-title">Register Your Company</div>
      <div class="pf-form-sub">Enter your company details below</div>
    </div>
    <div class="pf-form-body">
      <form action="{{ route('admin.companies.store') }}" method="POST">
        ...
        <div class="pf-form-actions">
          <button type="submit" class="pf-btn pf-btn-primary">Register Company</button>
        </div>
      </form>
    </div>
  </div>
